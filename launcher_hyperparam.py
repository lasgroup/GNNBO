...
default_configs = {
    ...
    'num_actions': 500, # any number below 10000 works.
    # GNN-UCB
    'pretrain_steps': 40,
    't_intersect': 80,
...
search_ranges = {
    ...
    # GNN-US
    'exploration_coef': ['loguniform', [-8, 1]],
    'alg_lambda': ['loguniform', [-8, 1]],  # keep it small.
    'pretrain_steps': ['intuniform', [40,100]],
...
def main(args):
    ...
    generate_run_commands(command_list, num_cpus=args.num_cpus, mode='euler',long=True, promt=True)

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Regret Run')
    # experiment parameters
    parser.add_argument('--exp_name', type=str,  default='hyper_param_search_us_new')
    parser.add_argument('--num_cpus', type=int, default=8)
    parser.add_argument('--num_hparam_samples', type=int, default=25)
