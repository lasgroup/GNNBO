...
applicable_configs = {
    'GNN-UCB':['exploration_coef','pretrain_steps', 'alg_lambda','neuron_per_layer','net'],
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str,  default='hyper_param_search_us')
    parser.add_argument('--num_cpus', type=int, default=8)
    parser.add_argument('--num_hparam_samples', type=int, default=12)
    ...
    parser.add_argument('--T', type=int, default=400) #change to 1500
